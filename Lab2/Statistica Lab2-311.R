...
#Afisarea unui mesaj
#print afiseaza continutul unui obiect print(x)
n <- 10
...
#Madalina Badescu |Andrei Trache
rm(list=objects())
?rm
...
#Andrei Trache
rep(c(2,3),c(1,3))
# Atentie, cei doi vectori trebuie sa aiba aceeasi lungime
# Eroare rep(c(2,3),c(1,3,1))
...
#Madalina Badescu
#Andrei Trache
(b <- c(rep(rep(c(0,2),3),1:6),rep(rep(c(0:3,6),c(2,4:7)),1:23)))
...
#Alex Olaru
#Andrei Cataron
#Vreau sa adun 1 la toate numerele de pe pozitiile impare
v <- 1:9
v2 <- c(1,0)
v1 <- v+v2
###########################################################################
