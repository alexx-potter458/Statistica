#Lab 10(saptamana 11) Statistica 311

#Esantionare dintr-o populatie normala
#m=3 sigma=2(dispersia=4)
m <- 3
sigma <- 2
xbar <- c()
for(i in 1:1000)
...
#Vectorul xbar contine mediile diferitelor esantioane extrase din populatia normala
medie_xbar <- mean(xbar)
dispersia_xbar <- var(xbar)
hist(xbar)
hist(x)
...
#Tema: 1)Ilustrati TLC pentru repartitiile: Poisson, Geometrica si Exponentiala pentru toate cele 4 dimensiuni de esantion
